...
public class Handles {
    ...
    public void narrowPairHandles(double doorWidthDouble, double doorHeightDouble, String hand, String handleType, boolean panic, boolean push, GraphicsContext gc) {
        ...
        if (hand.equals("Left")) {
            ...
            if (panic) {
                ...
                //Panic Pull Active
                pullHandlePoly[0] = startX + recWidth + doorWidthRatio + 50;     //First X Point
                pullHandlePoly[1] = startX + recWidth + doorWidthRatio + 50 + 20;//Second X point
                pullHandlePoly[2] = startX + recWidth + doorWidthRatio + 50 + 20;//Third X point
                pullHandlePoly[3] = startX + recWidth + doorWidthRatio + 50;     //Fourth X point
                pullHandlePoly1[0] = startX + recWidth + doorHeightRatio + recHeight + 110;     //First Y Point
                pullHandlePoly1[1] = startX + recWidth + doorHeightRatio + recHeight + 110;     //Second Y Point
                pullHandlePoly1[2] = startX + recWidth + doorHeightRatio + recHeight - 50 + 100 - 40;//Third Y Point
                pullHandlePoly1[3] = startX + recWidth + doorHeightRatio + recHeight - 50 + 100 - 40;//Fourth Y Point
                ...
                gc.setLineWidth(1.0);
                //Panic Push Active
                pushBarPoly[0] = startX + recWidth + doorWidthRatio + 90;
                pushBarPoly[1] = startX + ( 2 * recWidth) + ( 2 * doorWidthRatio) + 15;
                pushBarPoly1[0] = startX + recWidth + doorHeightRatio + recHeight - 50 + 100;
                pushBarPoly1[1] = startX + recWidth + doorHeightRatio + recHeight - 50 + 100;
                ...
                gc.setFill(Color.BLACK);
                gc.setFont(Font.font("default", FontWeight.BOLD, 30));
                gc.fillText("CVR", startX + recWidth + doorWidthRatio + 200, startX + recWidth + doorHeightRatio + recHeight - 50 + 100 + 7);
            } else {
                if (push) {
                    pushBarPoly[0] = startX + recWidth + doorWidthRatio + 50;
                    pushBarPoly[1] = startX + ( 2 * recWidth) + ( 2 * doorWidthRatio) + 55;
                    pushBarPoly1[0] = startX + recWidth + doorHeightRatio + recHeight - 50 + 100;
                    pushBarPoly1[1] = startX + recWidth + doorHeightRatio + recHeight - 50 + 100;
                    gc.setLineWidth(10.0);
                    gc.setStroke(Color.rgb(173, 172, 172));
    ...
    public void medSingleHandles(double doorWidthDouble, double doorHeightDouble, String hand, String handleType, boolean panic, boolean push, GraphicsContext gc) {
    ...
    public void medPairHandles(double doorWidthDouble, double doorHeightDouble, String hand, String handleType, boolean panic, boolean push, GraphicsContext gc) {
        ...
        if (hand.equals("Left")) {
            ...
            if (panic) {
                ...
                gc.setLineWidth(1.0);
                //Panic Push Inactive
                pushBarPoly[0] = startX + 60;
                pushBarPoly[1] = startX + recWidth + doorWidthRatio - 100;
                pushBarPoly1[0] = startX + recWidth + doorHeightRatio + recHeight - 50 + 100;
                pushBarPoly1[1] = startX + recWidth + doorHeightRatio + recHeight - 50 + 100;
                ...
                //Panic Push Active
                pushBarPoly[0] = startX + recWidth + doorWidthRatio + 90;
                pushBarPoly[1] = startX + ( 2 * recWidth) + ( 2 * doorWidthRatio) + 20;
                pushBarPoly1[0] = startX + recWidth + doorHeightRatio + recHeight - 50 + 100;
                pushBarPoly1[1] = startX + recWidth + doorHeightRatio + recHeight - 50 + 100;
                ...
                if (push) {
                    pushBarPoly[0] = startX + recWidth + doorWidthRatio + 50;
                    pushBarPoly[1] = startX + ( 2 * recWidth) + ( 2 * doorWidthRatio) + 40;
                    pushBarPoly1[0] = startX + recWidth + doorHeightRatio + recHeight - 50 + 100;
                    pushBarPoly1[1] = startX + recWidth + doorHeightRatio + recHeight - 50 + 100;
                    gc.setLineWidth(10.0);
                    gc.setStroke(Color.rgb(173, 172, 172));
    ...
    public void wideSingleHandles(double doorWidthDouble, double doorHeightDouble, String hand, String handleType, boolean panic, boolean push, GraphicsContext gc) {
