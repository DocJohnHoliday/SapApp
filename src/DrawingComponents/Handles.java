...
public class Handles{
    ...
    public void leftHandPull12(double doorHeightDouble, GraphicsContext gc) {
        ...
        pullHandlePoly[3] = startX;                 //Fourth X point
        double[] pullHandlePoly1 = new double[4];
        pullHandlePoly1[0] = startY + recWidth + doorHeightRatio + recHeight + 100 + 20;     //First Y Point
        pullHandlePoly1[1] = startY + recWidth + doorHeightRatio + recHeight + 100 + 20;     //Second Y Point
        pullHandlePoly1[2] = startY + recWidth + doorHeightRatio + recHeight - 50 + 100;//Third Y Point
        pullHandlePoly1[3] = startY + recWidth + doorHeightRatio + recHeight - 50 + 100;//Fourth Y Point
        gc.setLineWidth(10.0);
        gc.setStroke(Color.rgb(173, 172, 172));
    ...
    public void leftHandPull8Chrome(double doorHeightDouble, GraphicsContext gc) {
    ...
    public void rightHandPull12(double doorWidthDouble,double doorHeightDouble, GraphicsContext gc) {
    ...
    public void rightHandPull8Chrome(double doorWidthDouble,double doorHeightDouble, GraphicsContext gc) {
