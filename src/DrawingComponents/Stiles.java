...
public class Stiles {
    ...
    public void medPairStile(double doorWidthDouble, double doorHeightDouble, String doorHeightString, String color,  GraphicsContext gc) {
        ...
        if(color.equals("Bronze") || color.equals("Black")) {
            //Left Inactive Stile
            gc.setFill(Color.rgb(95, 87, 87));
            gc.fillRect(1450 - 24, 1450, 50, 350 + doorHeightRatio + 24 + 15 + 350);
            //Right Inactive Stile
            gc.setFill(Color.rgb(95, 87,87));
            gc.fillRect(1450 + 1 + 350 + doorWidthRatio - 25, 1450, 50, 350 + doorHeightRatio + 24 + 15 + 350);

            //Left Active Stile
            gc.setFill(Color.rgb(95, 87, 87));
            gc.fillRect(1450 + 1 + 350 + doorWidthRatio + 27, 1450, 50, 350 + doorHeightRatio + 24 + 15 + 350);
            //Right Active Stile
            gc.setFill(Color.rgb(95, 87,87));
            gc.fillRect(activeRightStile, 1450, 50, 350 + doorHeightRatio + 24 + 15 + 350);
        } else {
            //Left Inactive Stile
            gc.setFill(Color.rgb(95, 87, 87));
            gc.strokeRect(1450 - 24, 1450, 50, 350 + doorHeightRatio + 24 + 15 + 350);
            //Right Inactive Stile
            gc.setFill(Color.rgb(95, 87,87));
            gc.strokeRect(1450 + 1 + 350 + doorWidthRatio - 25, 1450, 50, 350 + doorHeightRatio + 24 + 15 + 350);

            //Left Active Stile
            gc.setFill(Color.rgb(95, 87, 87));
            gc.strokeRect(1450 + 1 + 350 + doorWidthRatio + 27, 1450, 50, 350 + doorHeightRatio + 24 + 15 + 350);
            //Right Active Stile
            gc.setFill(Color.rgb(95, 87,87));
            gc.strokeRect(activeRightStile, 1450, 50, 350 + doorHeightRatio + 24 + 15 + 350);
        }
    }
}
